...
function TemperatureReading(props: { value: number | null }) {
  ...
  return (
    <span className="inline-flex items-baseline gap-1 font-temperature font-normal tracking-tight">
      {mainDigits}
      <span className="align-bottom text-[0.5em] opacity-40">{fractionalDigit}°</span>
    </span>
  )
}
